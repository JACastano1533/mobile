		...
		<?php foreach ($nodes as $i => $node): ?>
			...
			<div class="panel-heading">
				...
				<a class="accordion-toggle" data-toggle="collapse"  href="#<?php echo $category_name_id . "_" . $i; ?>">
				   <span class="desp-section-accrdin"> <?php echo strip_tags($node['question']); ?> </span> <span class="glyphicon glyphicon-plus icon-plus-cus" aria-hidden="true" style="float:right;"></span>
				</a>
			    </h4>
			</div>
