...
<!--          <tr>
		    ...
		    <?php // $comments = uc_order_comments_load($order->order_id);
		    
		    if ($order_comments != "<i>No comments left.</i>") {
//			$driver_instructions = "";
//			foreach ($comments AS $comment) {
//			    if ($comment->order_status == "Driver Instructions") {
//				$driver_instructions = $comment->message;
//				break;
//			    }
//			}
			?>
			<tr>
			    <td colspan="2">
				<br /><b><?php print t('Driver Instructions:'); ?>&nbsp;</b>
...
<!--              <p><?php print t('Please note: This e-mail message is an automated notification. Please do not reply to this message.'); ?></p> -->
                  <p><?php print t('This e-mail is sent automatically. Do not reply to this message.'); ?></p>
                  <p><?php print t('If you have any questions, please call us: (800) 276-6322 or (619) 662-0495.'); ?><br></p>
