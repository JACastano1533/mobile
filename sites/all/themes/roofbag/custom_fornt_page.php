<div class="new_front_top_section">
    ...
    <img src="sites/all/themes/roofbag/images/FitCloseUp-850.fw.png" alt="Roofbag"/>
    ...
    <div class="row">
    	<div class="col-md-6">
    		<img style="padding-bottom: 10px;" class="img-responsive" src="sites/all/themes/roofbag/images/GrayCarrier-BlueCar-Desert.fw.png" alt="Roofbag"/>
    	</div>
    	<div class="col-md-6">
     		<img style="width: 100%" class="img-responsive" src="sites/all/themes/roofbag/images/RoofBag-Black-Cross-Bars-Desert.jpg" alt="Roofbag"/>
    	</div>
    </div>
</div>
...
<div class="panel-group" id="accordion">
	...
	<div class="panel-heading">
		...
		<a class="accordion-toggle" data-toggle="collapse"  href="#collapseOne" id="Description">
		   <b> Description </b> <span class="glyphicon glyphicon-plus" aria-hidden="true" style="float:right;"></span>
		</a>
	    </h4>
	</div>
...
<!--    <div class="panel panel-default" id="collapseOne_panel">
	...
	<div class="panel-heading">
		...
		<a class="accordion-toggle"  data-toggle="collapse"  href="#collapseFour" id="How soon can I get it?">
		  <b> How soon can I get it? </b> <span class="glyphicon glyphicon-plus" aria-hidden="true" style="float:right;"></span>
		</a>
	    </h4>
	</div>
...
//    }
	...
	<a class="accordion-toggle" data-toggle="collapse"  href="#collapseTwo" id="collapseTwoLink">
		<b> Does it fit my car? </b><span class="glyphicon ' . $collapse_glyphicon . '" aria-hidden="true" style="float:right;"></span>
	</a></h4>
	...
	<div class="panel-heading">
		...
		<a class="accordion-toggle" data-toggle="collapse"  href="#collapseSix" id="collapseSixLink">
		  <b> How does it attach? </b><span class="glyphicon glyphicon-plus" aria-hidden="true" style="float:right;"></span>
		</a>
	    </h4>
	</div>
	...
	<div id="collapseSix" class="panel-collapse collapse ">
	    <div class="panel-body">
		<div class="vehicle_feature">
		    <p><b>Click on your rack style</b></p>
...
<?php if ($roofbag_exists) {
    ...
    $accessories_txt = "<b> Accessories </b>";
} ?>
...
<!-- end of heatmap code from LuckyOrange.com -->
	...
	//Show TrustPilot reviews only to IPGroups 2 and 3. Start: 3/13/2018 - 3:53 PM
...
s1.async=true;
s1.src='https://embed.tawk.to/5a865d24d7591465c707b833/1c6g8jlmk';
s1.charset='UTF-8';
