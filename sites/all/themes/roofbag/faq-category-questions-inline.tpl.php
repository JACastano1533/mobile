...
?>
<?php $category_name_id = preg_replace('/[^a-zA-Z]/', '', strtolower(strip_tags($header_title))); ?>
<div class="faq-category-group">
	...
	<div>
		...
		<?php foreach ($nodes as $i => $node): ?>
		    <div class="panel panel-default" id="<?php echo $category_name_id . "_" . $i; ?>_panel">
			<div class="panel-heading">
			    <h4 class="panel-title">
                   <?php $question_title = strip_tags($node['question']);?>
				<a class="accordion-toggle" data-toggle="collapse"  href="#<?php echo $category_name_id . "_" . $i; ?>">
				   <span class="desp-section-accrdin"> <?php echo bb2html($question_title); ?> </span> <span class="glyphicon glyphicon-plus icon-plus-cus" aria-hidden="true" style="float:right;"></span>
				</a>
			    </h4>
			</div>
			<div id="<?php echo $category_name_id . "_" . $i; ?>" class="panel-collapse collapse">
