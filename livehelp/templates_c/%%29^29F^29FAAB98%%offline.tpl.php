<?php /* Smarty version 2.6.27, created on 2018-01-09 14:02:00
...
<div class="LiveHelpOfflineForm" style="position:absolute; right:20px; top:20px; background:url(<?php echo $this->_tpl_vars['url']; ?>
images/OfflineStamp.png) no-repeat; width:149px; height:93px;"></div>
<?php endif; ?>
...
" size="40" tabindex="10" style="background:#FBFBFB; color:#555; border:none; outline:none; margin:0; padding:0; font-size:16px; width:<?php echo $this->_tpl_vars['SETTINGS']['CHATWINDOWWIDTH']-250; ?>
...
" size="40" tabindex="11" style="background:#FBFBFB; color:#555; border:none; outline:none; margin:0; padding:0; font-size:16px; width:<?php echo $this->_tpl_vars['SETTINGS']['CHATWINDOWWIDTH']-250; ?>
px;; -webkit-box-shadow:none; -moz-box-shadow:none; -box-shadow:none" <?php if ($this->_tpl_vars['disabled']): ?>disabled="disabled"<?php endif; ?>/>
...
; resize:none; overflow:auto; -webkit-box-shadow:none; -moz-box-shadow:none; -box-shadow:none" <?php if ($this->_tpl_vars['disabled']): ?>disabled="disabled"<?php endif; ?>><?php echo $this->_tpl_vars['message']; ?>
            ...
            <input x-webkit-speech="x-webkit-speech" id="MESSAGESPEECH" style="font-size: 15px; width: 15px; height: 15px; cursor:pointer; border: none; position: absolute; right: -20px; margin-left: 5px; outline: none; background: transparent; color: transparent" />
      ...
      <tr>
		...
		<div style="position:relative; background:#FBFBFB; border:1px solid #E5E5E5; width:125px; height:20px; padding:3px; margin: 0">
			<input name="CAPTCHA" type="text" id="CAPTCHA" value="" size="6" tabindex="13" style="background:#FBFBFB; color:#555; border:none; outline:none; margin:0; padding:0px; font-size:16px; width:100px; -webkit-box-shadow:none; -moz-box-shadow:none; -box-shadow:none" maxlength="5" <?php if ($this->_tpl_vars['disabled']): ?>disabled="disabled"<?php endif; ?>/>
