...
<div class="LiveHelpOfflineForm" style="position:absolute; right:20px; top:20px; background:url({$url}images/OfflineStamp.png) no-repeat; width:149px; height:93px;"></div>
{/if}
    ...
    <table border="0" align="center" cellpadding="2" cellspacing="2">
      ...
      <tr>
		...
		<div style="position:relative; background:#FBFBFB; border:1px solid #E5E5E5; width:125px; height:20px; padding:3px; margin: 0">
			<input name="CAPTCHA" type="text" id="CAPTCHA" value="" size="6" tabindex="13" style="background:#FBFBFB; color:#555; border:none; outline:none; margin:0; padding:0px; font-size:16px; width:100px; -webkit-box-shadow:none; -moz-box-shadow:none; -box-shadow:none" maxlength="5" {if $disabled}disabled="disabled"{/if}/>
