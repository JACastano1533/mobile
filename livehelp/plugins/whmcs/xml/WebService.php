...
function IsAuthorized() {
	...
	$query = sprintf("SELECT `id`, `username`, `password`, `firstname`, `lastname`, `department`, `datetime`, `privilege`, `status` FROM `" . $_SETTINGS['TABLEPREFIX'] . "users` WHERE `username` LIKE BINARY '%s' AND `disabled` = 0", $SQL->escape($_REQUEST['Username']));
