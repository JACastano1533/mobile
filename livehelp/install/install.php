...
$directory = substr($_SERVER['SCRIPT_NAME'], 0, strpos($_SERVER['SCRIPT_NAME'], '/livehelp-pro/'));
			...
			if (empty($error)) {
				...
				foreach ($settings as $key => $line) {
					if (trim($line) != '' && substr(trim($line), 0, 1) != '#') {
						...
						$line = str_replace('/livehelp-pro/locale/en/images/Online.png', $address . '/livehelp-pro/locale/en/images/Online.png', $line);
						$line = str_replace('/livehelp-pro/locale/en/images/Offline.png', $address . '/livehelp-pro/locale/en/images/Offline.png', $line);
						$line = str_replace('/livehelp-pro/locale/en/images/BeRightBack.png', $address . '/livehelp-pro/locale/en/images/BeRightBack.png', $line);
						$line = str_replace('/livehelp-pro/locale/en/images/Away.png', $address . '/livehelp-pro/locale/en/images/Away.png', $line);
